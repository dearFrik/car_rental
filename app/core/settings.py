...
SECRET_KEY = 'django-insecure-*#51yvy281ckx6mmmh+3i!8hm4-39o)2r9_l=eg_nw3(52+^9a'
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('DB_USER', 'car_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'car_password_123'),
